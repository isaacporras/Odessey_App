...
//        **************//
    ...
    public static void AddStars_cancion(String song, String stars){
        DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
        DocumentBuilder dBuilder = null;
        ...
        Element PlaylistNameElement = SongXML.createElement("Stars");
        PlaylistNameElement.appendChild(SongXML.createTextNode(stars));
